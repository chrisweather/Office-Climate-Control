...
void ReadSensor1() 
{
  ...
  if (CO2value >= 1000) {  // Display current CO2 value and warning >=1000 ppm
    ...
    u8g2ada.setForegroundColor(RED);
    u8g2ada.setCursor(64 - (u8g2ada.getUTF8Width("  Please  ")) / 2, 74);  // "Please"
    u8g2ada.print("  Please  ");
    u8g2ada.setCursor(64 - (u8g2ada.getUTF8Width("ventilate")) / 2, 103);  // "ventilate!"
    u8g2ada.print("ventilate");
  }
  else {
...
void BreakTimer()
{
  if (tS3.isLastIteration() == false){
    ...
    u8g2ada.print("Break in ");  // "Break in "
...
void BreakMsg()
{
  ...
  if (CO2value < 1000) {
    ...
    u8g2ada.setForegroundColor(RED);
    u8g2ada.setCursor(64 - (u8g2ada.getUTF8Width(" Have a ")) / 2, 74);  // "Have a"
    u8g2ada.print(" Have a ");
    u8g2ada.setCursor(64 - (u8g2ada.getUTF8Width(" Break! ")) / 2, 103);  // "Break!"
    u8g2ada.print(" Break! ");
  }
  else {
    u8g2ada.setFont(u8g2_font_inb16_mf);
